...
public class Code4Life {
	...
	public static void main(String[] args) {
		playBatmanTheme();
		String Dino = JOptionPane.showInputDialog("How many hours do you spend coding a week?");
	 int Bob =Integer.parseInt(Dino);
	 
	 if (Bob < 3){ 
		 JOptionPane.showInputDialog("Then get off of youtube and start coding");
	}
	 else if(Bob > 5){
		 JOptionPane.showInputDialog("You like a coding Ninja");
	}
	}
