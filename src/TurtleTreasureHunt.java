...
if (tortoiseLocationX==500){
	JOptionPane.showMessageDialog(null, "I saw it with the boy");
}
if (tortoiseLocationX==140){
	JOptionPane.showMessageDialog(null,"I gave it to the parrot");
}
if (tortoiseLocationX==570){
	JOptionPane.showMessageDialog(null, "Squak! THE DANG FISH TOOK IT!!!");
}
if (tortoiseLocationX==320){
	JOptionPane.showMessageDialog(null, "Glup! I'm never going to tell you where i hid it!(Looks at the pirate hat).");
}
if (tortoiseLocationX==400){
	JOptionPane.showMessageDialog(null, "Congrats You Found The Burried treasure!");
	Paintable backgroundImage = new ImageBackground("file:/Users/League/Desktop/Level0/DisneyWorld.jpg");
